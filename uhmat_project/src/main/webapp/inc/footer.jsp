		...
		<!-- 로고 들어가는 곳 -->	
			...
			<div class="footerMenu">
				<table id="footerTable"> 
					<tr>
						<td id="whatUhmat"><a href="./company/companyModify.jsp">어맛 소개</a></td>
						<td id="notice"><a href="./serviceCenter/notice/noticeDetail.jsp">공지사항</a></td>
					</tr>
					<tr>
						<td id="whoDeveloper"><a href="./company/developerModify.jsp">개발자 소개</a></td>
						<td id="serviceCenter"><a href="./serviceCenter/faq/faqlist.jsp">고객센터</a></td>
					</tr>
					<tr>
						<td id="policy"><a href="./company/policy.jsp">이용약관</a></td>
						<td id="event"><a href="./event/NewFile.jsp">이벤트</a></td>
					<tr>
				</table>
			</div>
