...
//			System.out.println(mateReply);
	...
	// 답글(대댓글) 입력 작업 메서드
	public int insertTmiRereply(TmiReplyDTO tmiReply) {
		...
		try {
			...
			pstmt2 = con.prepareStatement(sql);
			pstmt2.setInt(1, tmiReply.getRe_seq());
			...
			pstmt3 = con.prepareStatement(sql);
			pstmt3.setInt(1, idx);
			pstmt3.setInt(2, tmiReply.getBoard_idx());
			pstmt3.setString(3, tmiReply.getNickname());
			pstmt3.setString(4, tmiReply.getContent());
			pstmt3.setInt(5, tmiReply.getIdx());
			pstmt3.setInt(6, tmiReply.getRe_lev() + 1);
			pstmt3.setInt(7, tmiReply.getRe_seq() + 1);
